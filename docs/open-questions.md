...
- ~~**D-10 — Formatter engine (gates A7)**~~ ✅ RESOLVED 2026-06-19: **Eclipse JDT** via a single central
  ...
  was dropped (VS-Code-only / Java-primary). See the 2026-06-19 Decision row. **Open finishing-step:** the
  one-time wildcard→explicit expansion (IDE) + a build gate against new wildcards.
