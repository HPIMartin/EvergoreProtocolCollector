...
|---|-----------|-------|-------------------|
| M1 | Data integrity | B15, B14, B9, B11 | An aborted run under-counts permanently and the game serves only ~30 days of logs, so waiting loses data irreversibly (decision 2026-07-17) |
