...
(decision 2026-07-17: integrity before dashboard, an aborted run under-counts permanently). Then
**E5**'s remaining strands **`json-api`** → **`spa-views`** (decision 2026-07-04),
