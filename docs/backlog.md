...
entries every run plus the ingest boundary-minute fix; design decision 2026-07-17; integrity before
dashboard, an aborted run under-counts permanently). Then
