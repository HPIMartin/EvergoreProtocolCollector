...
| Gildenlagerwert (what the storage holds at the guild's own price) | `20.231.794` |
| Gildenspende (deposits the guild credits nothing for) | `104.597.124` |
| Handwerkssubventionen (what the guild credits above its own price) | `39.441.922` |
| Nach Abzügen, the table's total row | `74.410.839` |
